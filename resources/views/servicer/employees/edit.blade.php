...
@section('content')
    ...
    <section class="content">
        ...
        <div class="box">
            <form action="{{ route('servicer.employees.update', $employee->id) }}" method="post" class="form">
                <div class="box-body">
                    {{ csrf_field() }}
                    ...
                    @include('servicer.shared.status-select', ['status' => $employee->status])
                </div>

                <!-- /.box-body -->
                <div class="box-footer">
                    <div class="btn-group">
                        <a href="{{ route('servicer.employees.index') }}" class="btn btn-default btn-sm">Back</a>
