   ...
   <div class="box">
      <div class="box-body">
         <div class="card">
            ...
            <div class="card-body">
               <a href="{{ url('/servicer/route/'.$route_request->routeId.'/requests') }}" title="Back"><button class="btn btn-warning btn-sm"><i class="fa fa-arrow-left" aria-hidden="true"></i> {{ __('admin/common.action_back') }}</button></a>		    
               <br/>		    
                  ...
                  <table class="table">
                     <tbody>
                        ...
                        <tr>
                           ...
                           <td> {{ env('CURRENCY_SYMBOL').$route_request->requestedUnitPrice }}  per {{ $route_request->requestedMassUnit}} </td>
                        </tr>
