...
@section('content')
    ...
    <section class="content">
        ...
        <div class="box">
            <form action="{{ route('servicer.countries.update', $country->id) }}" method="post" class="form" enctype="multipart/form-data">
                <div class="box-body">
                ...
                <div class="box-footer">
                    <div class="btn-group">
                        <a href="{{ route('servicer.countries.index') }}" class="btn btn-default">Back</a>
