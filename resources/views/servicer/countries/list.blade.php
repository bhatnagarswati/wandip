                    ...
                    <table class="table table-bordered table-striped">
                        ...
                        @foreach ($countries as $country)
                            <tr>
                                ...
                                <td>
                                    <div class="btn-group">
                                        <a href="{{ route('servicer.countries.show', $country->id) }}" class="btn btn-default btn-sm"><i class="fa fa-eye"></i> Show</a>
                                        <a href="{{ route('servicer.countries.edit', $country->id) }}" class="btn btn-primary btn-sm"><i class="fa fa-edit"></i> Edit</a>
                                    </div>
                                </td>
                            </tr>
                        @endforeach
