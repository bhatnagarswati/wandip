...
@section('content')
    ...
    <section class="content">
        ...
        <!-- Default box -->
        <div class="box">
            <form action="{{ route('servicer.payment-methods.update', $paymentMethod->id) }}" method="post">
            <div class="box-body">
                ...
                @include('servicer.shared.status-select', ['status' => $paymentMethod->status])
            </div>
            <!-- /.box-body -->
                <div class="box-footer btn-group">
                    <a href="{{ route('servicer.payment-methods.index') }}" class="btn btn-default">Back</a>
