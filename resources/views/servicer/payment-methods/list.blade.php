                    ...
                    <table class="table table-bordered table-striped">
                        ...
                        @foreach ($paymentMethods as $paymentMethod)
                            <tr>
                                ...
                                <td>
                                    <form action="{{ route('servicer.payment-methods.destroy', $paymentMethod->id) }}" method="post" class="form-horizontal">
                                        {{ csrf_field() }}
                                        <input type="hidden" name="_method" value="delete">
                                        <div class="btn-group">
                                            <a href="{{ route('servicer.payment-methods.edit', $paymentMethod->id) }}" class="btn btn-primary btn-sm"><i class="fa fa-edit"></i> Edit</a>
