    ...
    <!-- Default box -->
        <div class="box">
            <div class="box-header">
                <div class="row">
                    <div class="col-md-6">
                        <h2>
                            <a href="{{ route('servicer.customers.show', $customer->id) }}">{{$customer->name}}</a> <br />
                            <small>{{$customer->email}}</small> <br />
                            <small>reference: <strong>{{$order->reference}}</strong></small>
                        </h2>
                    </div>
                    <div class="col-md-3 col-md-offset-3">
                        <h2><a href="{{route('servicer.orders.invoice.generate', $order['id'])}}" class="btn btn-primary btn-block">Download Invoice</a></h2>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="box-body">
                ...
                <table class="table table-bordered table-striped">
                    ...
                    <tr>
                        ...
                        <td><a href="{{ route('servicer.customers.show', $customer->id) }}">{{ $customer->name }}</a></td>
        ...
        @if($order)
            ...
            <div class="box-footer">
                <div class="btn-group">
                    <a href="{{ route('servicer.orders.index') }}" class="btn btn-default">Back</a>
                    @if($user->hasPermission('update-order'))<a href="{{ route('servicer.orders.edit', $order->id) }}" class="btn btn-primary">Edit</a>@endif
                </div>
            </div>
        @endif
