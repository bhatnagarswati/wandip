    ...
    <section class="content">
        ...
        <div class="box">
                    ...
                    <table class="table">
                        ...
                        @foreach ($addresses as $address)
                            <tr>
                                ...
                                <td>
                                    <form action="{{ route('servicer.addresses.destroy', $address->id) }}" method="post" class="form-horizontal">
                                        {{ csrf_field() }}
                                        <input type="hidden" name="_method" value="delete">
                                        <div class="btn-group">
                                             <!-- <a href="{{ route('servicer.customers.addresses.show', [$customer->id, $address->id]) }}" class="btn btn-default btn-sm"><i class="fa fa-eye"></i> {{ __('admin/common.action_show') }}</a>
                                            <a href="{{ route('servicer.customers.addresses.edit', [$customer->id, $address->id]) }}" class="btn btn-primary btn-sm"><i class="fa fa-edit"></i> Edit</a> -->
            ...
            <div class="box-footer">
                <div class="btn-group">
                    <a href="{{ route('servicer.customers.index') }}" class="btn btn-default btn-sm">{{ __('admin/common.action_back') }}</a>
                </div>
            </div>
        </div>
        <!-- /.box -->
