            ...
            <table class="table table-bordered table-striped">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <form action="{{ route('servicer.customers.destroy', $customer['id']) }}" method="post"
                                class="form-horizontal">
                                {{ csrf_field() }}
                                <input type="hidden" name="_method" value="delete">
                                <div class="btn-group">
                                    <a href="{{ route('servicer.customers.show', $customer['id']) }}"
                                        class="btn btn-info btn-sm"><i class="fa fa-eye"></i> {{ __('admin/common.action_show') }}</a> &nbsp;&nbsp;
                                    <a href="{{ route('servicer.customers.edit', $customer['id']) }}"
