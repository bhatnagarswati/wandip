...
@section('content')
    ...
    <section class="content">
        ...
        <div class="box">
            <form action="{{ route('servicer.couriers.update', $courier->id) }}" method="post" class="form">
                <div class="box-body">
                    {{ csrf_field() }}
                    ...
                    <div class="form-group">
                        @include('servicer.shared.status-select', ['status' => $courier->status])
                    </div>
                </div>
                <!-- /.box-body -->
                <div class="box-footer">
                    <div class="btn-group">
                        <a href="{{ route('servicer.couriers.index') }}" class="btn btn-default">Back</a>
