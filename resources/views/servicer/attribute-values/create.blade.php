...
@section('content')
    ...
    <section class="content">
        ...
        <div class="box">
            <form action="{{ route('servicer.attributes.values.store', $attribute->id) }}" method="post" class="form">
                <div class="box-body">
                    <div class="row">
                        {{ csrf_field() }}
                        <div class="col-md-12">
                ...
                <div class="box-footer">
                    <div class="btn-group">
                        <a href="{{ route('servicer.attributes.show', $attribute->id) }}" class="btn btn-default btn-sm">Back</a>
