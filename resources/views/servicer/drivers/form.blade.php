<div class="form-group {{ $errors->has('driverEmail') ? 'has-error' : ''}}">
    ...
    <input class="form-control" name="driverEmail" type="email" id="driverEmail"
        value="{{ isset($driver->driverEmail) ? $driver->driverEmail : ''}}">
...
<div class="form-group {{ $errors->has('password') ? 'has-error' : ''}}">
    ...
    <input class="form-control" name="password" type="password" id="password"
        value="{{ isset($driver->password) ? $driver->driverPassword : ''}}">
...
<div class="form-group {{ $errors->has('firstName') ? 'has-error' : ''}}">
    ...
    <input class="form-control" name="firstName" type="text" id="firstName"
        value="{{ isset($driver->firstName) ? $driver->firstName : ''}}">
...
<div class="form-group {{ $errors->has('lastName') ? 'has-error' : ''}}">
    ...
    <input class="form-control" name="lastName" type="text" id="lastName"
        value="{{ isset($driver->lastName) ? $driver->lastName : ''}}">
...
<div class="form-group {{ $errors->has('contactNumber') ? 'has-error' : ''}}">
    ...
    <input class="form-control" name="contactNumber" type="text" id="contactNumber"
        value="{{ isset($driver->contactNumber) ? $driver->contactNumber : ''}}">
...
<div class="form-group {{ $errors->has('address') ? 'has-error' : ''}}">
    ...
    <input class="form-control autocomplete" name="address"  id="address" value="{{ isset($driver->address) ? $driver->address : ''}}"></textarea>
...
<div class="form-group {{ $errors->has('licenceNumber') ? 'has-error' : ''}}">
    ...
    <input class="form-control" name="licenceNumber" type="text" id="licenceNumber"
        value="{{ isset($driver->licenceNumber) ? $driver->licenceNumber : ''}}">
...
<div class="form-group {{ $errors->has('driverPic') ? 'has-error' : ''}}">
    ...
    <label class="btn btn-default btn-file">
        Browse <input class="form-control showPic " name="driverPic" id="driverPic" type="file" style="display: none;"
...
<div class="form-group {{ $errors->has('idProof') ? 'has-error' : ''}}">
    ...
    <label class="btn btn-default btn-file">
        Browse <input class="form-control showPic showPic_proof" name="idProof" id="idProof" type="file"
...
<div class="form-group {{ $errors->has('status') ? 'has-error' : ''}}">
    ...
    <select class="form-control" name="status" id="status">
        <option value="1" @if(!empty($driver)) @if($driver->status == 1) {{ "selected"}} @endif @endif
            >{{ __('admin/drivers.driver_active') }}</option>
        <option value="0" @if(!empty($driver)) @if($driver->status == 0) {{ "selected"}} @endif @endif
            >{{ __('admin/drivers.driver_inactive') }}</option>
    </select>
    {!! $errors->first('status', '
    <p class="help-block">:message</p>
    ') !!}
...
<div class="form-group">
    ...
    <a href="{{ url('/servicer/drivers') }}" class="btn btn-warning" title="Back"> <i class="fa fa-arrow-left"
