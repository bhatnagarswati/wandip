...
@section('content')
    ...
    <section class="content">
        ...
        <div class="box">
            <form action="{{ route('servicer.addresses.update', $address->id) }}" method="post" class="form" enctype="multipart/form-data">
                <div class="box-body">
                    {{ csrf_field() }}
                    ...
                    <div class="form-group">
                        @include('servicer.shared.status-select', ['status' => $address->status])
                    </div>
                </div>
                <!-- /.box-body -->
                <div class="box-footer">
                    <div class="btn-group">
                        <a href="{{ route('servicer.addresses.index') }}" class="btn btn-default">Back</a>
