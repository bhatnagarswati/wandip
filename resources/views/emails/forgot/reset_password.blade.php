...
<div class="container custom">
  ...
  <form class="form-horizontal" id="validationForm" name="validationForm" method="POST" action="{{url('/auth/change_password')}}" >
    {{ csrf_field() }}
    {{ method_field('POST') }}
    ...
    <div class="form-group">
      <div class="col-sm-offset-2 col-sm-10">
        <button type="submit" name="reset" class="btn btn-default">Update Password</button>
      </div>
    </div>
  </form>
</div>
