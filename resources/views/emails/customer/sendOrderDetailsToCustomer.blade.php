...
<body>
    <section class="container">
        <div class="col-md-12">
            ...
            <p>Address: {{$address->address_1}} {{$address->address_2}} {{$address->city}} {{$address->state_code}},
                {{$country->name}}</p>
            <table class="table table-striped" width="100%" border="0" cellspacing="0" cellpadding="0">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            @php($pattr =
                            \App\Shop\ProductAttributes\ProductAttribute::find($product->pivot->product_attribute_id))
                            @if(!is_null($pattr))<br>
                        ...
                        <td class="text-right">{{config('cart.currency')}}
                ...
                <tfoot>
                    <tr>
                        ...
                        <td></td>
                        <td>Subtotal:</td>
                        <td class="text-right">{{config('cart.currency')}} {{number_format($order->total_products, 2)}}
                        </td>
                    </tr>
                    <tr>
                        <td></td>
                        ...
                        <td></td>
                        <td>Shipping:</td>
                        <td class="text-right">{{config('cart.currency')}} {{number_format($order->total_shipping, 2)}}
                        </td>
                    </tr>
                    <tr>
                        <td></td>
                        ...
                        <td></td>
                        <td>Discounts:</td>
                        <td class="text-right">({{config('cart.currency')}} {{number_format($order->discounts, 2)}})
                        </td>
                    </tr>
                    <tr>
                        <td></td>
                    ...
                    <tr class="bg-warning">
                        ...
                        <td class="text-right"><strong>{{config('cart.currency')}}
