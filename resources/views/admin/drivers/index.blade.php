         ...
         <table class="table table-bordered table-striped">
            <thead>
               <tr>
                  ...
                  <th>{{ __('admin/drivers.Servicer') }}</th>
...
<!--                  <td>{{ strlen($item->address) > 15 ? substr($item->address, 0, 15)."..." : $item->address  }}</td>-->
                  <td>{{ strlen($item->licenceNumber) > 15 ? substr($item->licenceNumber, 0, 15)."..." : $item->licenceNumber  }} </td>
