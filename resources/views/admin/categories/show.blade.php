                            ...
                            <tr>
                                ...
                                <td>
                                    @if(isset($category->cover))
                                        <img   width="150px" src="{{ asset("storage/app/public/$category->cover") }}" alt="category image" class="img-thumbnail">
                                    @endif
                                </td>
                            </tr>
                        </tbody>
                            ...
                            <tbody>
                                @foreach($categories as $cat)
                                    <tr>
                                        ...
                                        <td>@if(isset($cat->cover))<img src="{{ asset("storage/app/public/$cat->cover") }}" alt="category image" class="img-thumbnail">@endif</td>
