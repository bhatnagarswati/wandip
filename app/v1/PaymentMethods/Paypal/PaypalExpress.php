...
namespace App\v1\PaymentMethods\Paypal;
...
/**
 * Class PaypalExpress
 * @package App\v1\PaymentMethods\Paypal
 * @codeCoverageIgnore
 *
...
class PaypalExpress
{
    ...
    public function setItems(Collection $products)
    {
        ...
        foreach ($products as $product) {
            ...
            $item->setName($product->name)
                ...
                ->setCurrency(v1pingCart::$defaultCurrency)
    ...
    {
        $amount = new Amount();
        $amount->setCurrency(v1pingCart::$defaultCurrency)
            ->setTotal($amt)
