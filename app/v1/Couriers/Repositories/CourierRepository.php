...
namespace App\v1\Couriers\Repositories;

use Jsdecena\Baserepo\BaseRepository;
use App\v1\Couriers\Courier;
use App\v1\Couriers\Exceptions\CourierInvalidArgumentException;
use App\v1\Couriers\Exceptions\CourierNotFoundException;
