...
namespace App\v1\Addresses\Repositories;

use App\v1\Addresses\Address;
use App\v1\Addresses\Exceptions\CreateAddressErrorException;
use App\v1\Addresses\Exceptions\AddressNotFoundException;
