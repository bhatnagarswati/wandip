...
class RouteRequestController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        if (!empty($keyword)) {
            ...
            $route_requests = RouteRequest::with(['driverinfo', 'servicerinfo', 'customerinfo'])->where(['servicerId' => Auth::guard('servicer')->user()->id, 'routeId' => $routeid])->orderBy('routeId')->latest()->paginate($perPage);
        }
    ...
    public function show($id)
    {
        ...
        return view('servicer.route-requests.show', compact('route_request'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('servicer.route-requests.edit', compact('routes', 'weight_units', 'drivers'));
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect('servicer/route/' . $routeId . '/requests')->with('message', 'Request deleted!');
    }
    /**
    ...
    public function cancelRequest($id)
    {
        ...
        return redirect('servicer/route/' . $cancelrequest->routeId . '/requests')->with('message', 'Request cancelled successfully!');
    }
    ...
    public function activateRequest($id)
    {
        ...
        return redirect('servicer/route/' . $activaterequest->routeId . '/requests')->with('message', 'Request activated successfully!');
    }
}
