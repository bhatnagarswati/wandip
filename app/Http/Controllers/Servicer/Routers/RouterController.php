...
namespace App\Http\Controllers\Servicer\Routers;
...
class RouterController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        if (!empty($keyword)) {
            ...
            $routes = Router::with(['routeInfo', 'driver', 'servicer'])->where(['servicerId' => Auth::guard('servicer')->user()->id, 'languageType' => Config::get('app.locale')])->latest()->paginate($perPage);
        }
	      
        return view('servicer.routers.index', compact('routes'));
    }
