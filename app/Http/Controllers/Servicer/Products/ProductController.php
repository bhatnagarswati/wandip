...
namespace App\Http\Controllers\Servicer\Products;
...
class ProductController extends Controller
{
    ...
    public function __construct(
        ...
        //$this->middleware(['permission:create-product, guard:servicer'], ['only' => ['create', 'store']]);
        //$this->middleware(['permission:update-product, guard:servicer'], ['only' => ['edit', 'update']]);
        //$this->middleware(['permission:delete-product, guard:servicer'], ['only' => ['destroy']]);
        //$this->middleware(['permission:view-product, guard:servicer'], ['only' => ['index', 'show']]);
    }
    ...
    public function index()
    {
        ...
        $storeIds = Store::where('servicerId', Auth::guard('servicer')->user()->id)->pluck('id');

        $list = $this->productRepo->listProducts('id')->where('languageType', Config::get('app.locale'))->whereIn('store_id', $storeIds);
        ...
        return view('servicer.products.list', [
    ...
    public function create()
    {
        ...
        return view('servicer.products.create', [
            ...
            'product' => new Product,
            'stores' => Store::where('servicerId', Auth::guard('servicer')->user()->id)->get(),
        ]);
    }
    ...
    public function store(CreateProductRequest $request)
    {
        ...
        return redirect()->route('servicer.products.edit', $product->id)->with('message', 'Create successful');
    }
    ...
    public function show(int $id)
    {
        ...
        return view('servicer.products.show', compact('product'));
    }
    ...
    public function edit(int $id)
    {
        ...
        return view('servicer.products.edit', [
            'product' => $product,
    ...
    public function update(UpdateProductRequest $request, int $id)
    {
        ...
        return redirect()->route('servicer.products.edit', $id)
    ...
    public function destroy($id)
    {
        ...
        return redirect()->route('servicer.products.index')->with('message', 'Delete successful');
    }
