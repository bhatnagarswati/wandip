...
class EmployeeController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('servicer.employees.list', [
    ...
    public function create()
    {
        ...
        return view('servicer.employees.create', compact('roles'));
    }
    ...
    public function store(CreateEmployeeRequest $request)
    {
        ...
        return redirect()->route('servicer.employees.index');
    }
    ...
    public function show(int $id)
    {
        ...
        return view('servicer.employees.show', ['employee' => $employee]);
    }
    ...
    public function update(UpdateEmployeeRequest $request, $id)
    {
        ...
        return redirect()->route('servicer.employees.edit', $id)
    ...
    public function destroy(int $id)
    {
        ...
        return redirect()->route('servicer.employees.index')->with('message', 'Delete successful');
    }
    ...
    public function updateProfile(UpdateEmployeeRequest $request, $id)
    {
        ...
        return redirect()->route('servicer.employee.profile', $id)
            ->with('message', 'Update successful');
    }
}
