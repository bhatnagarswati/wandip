...
namespace App\Http\Controllers\Servicer\Drivers;
...
class DriverController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        if (!empty($keyword)) {
            ...
            $drivers = Driver::where('servicerId', Auth::guard('servicer')->user()->id)->latest()->paginate($perPage);
        }

        return view('servicer.drivers.index', compact('drivers'));
    }
    ...
    {
        return view('servicer.drivers.create');
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect('servicer/drivers')->with('flash_message', 'Driver added!');
    }
    ...
    public function show($id)
    {
        ...
        return view('servicer.drivers.show', compact('driver'));
    }
    ...
    {
        $driver = Driver::findOrFail($id);
        return view('servicer.drivers.edit', compact('driver'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        if ($request->input('driverEmail') != $driver->driverEmail) {

            $validator = Validator::make($request->all(), [
                'driverEmail' => 'required|string|unique:drivers',
            ]);
            if ($validator->fails()) {
                return redirect()->back()->withErrors($validator)->withInput();
            }
        ...
        $driver->servicerId = Auth::guard('servicer')->user()->id;
        $driver->driverEmail = $request->input('driverEmail');
        if (!empty($request->input('password'))) {
        ...
        return redirect('servicer/drivers')->with('flash_message', 'Driver updated!');
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect('servicer/drivers')->with('flash_message', 'Driver deleted!');
    }
}
