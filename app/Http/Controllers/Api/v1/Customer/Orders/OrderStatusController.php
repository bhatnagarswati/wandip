...
use App\v1\OrderStatuses\Requests\CreateOrderStatusRequest;
use App\v1\OrderStatuses\Requests\UpdateOrderStatusRequest;
...
class OrderStatusController extends Controller
{
    ...
    {
        return view('servicer.order-statuses.list', ['orderStatuses' => $this->orderStatuses->listOrderStatuses()]);
    }
    ...
    {
        return view('servicer.order-statuses.create');
    }
    ...
    public function store(CreateOrderStatusRequest $request)
    {
        ...
        return redirect()->route('servicer.order-statuses.index');
    }
    ...
    {
        return view('servicer.order-statuses.edit', ['orderStatus' => $this->orderStatuses->findOrderStatusById($id)]);
    }
    ...
    public function update(UpdateOrderStatusRequest $request, int $id)
    {
        ...
        return redirect()->route('servicer.order-statuses.edit', $id);
    }
