...
namespace App\Http\Controllers\Api\v1\Servicer\Roles;
...
use App\v1\Roles\Requests\CreateRoleRequest;
use App\v1\Roles\Requests\UpdateRoleRequest;
...
class RoleController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('servicer.roles.list', compact('roles'));
    }
    ...
    {
        return view('servicer.roles.create');
    }
    ...
    public function store(CreateRoleRequest $request)
    {
        ...
        return redirect()->route('servicer.roles.index')
    ...
    public function edit($id)
    {
        ...
        return view('servicer.roles.edit', compact(
            'role',
            'permissions',
    ...
    public function update(UpdateRoleRequest $request, $id)
    {
        ...
        return redirect()->route('servicer.roles.edit', $id)
