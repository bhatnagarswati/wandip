...
namespace App\Http\Controllers\Api\v1\Servicer\Couriers;

use App\v1\Couriers\Repositories\CourierRepository;
use App\v1\Couriers\Repositories\Interfaces\CourierRepositoryInterface;
use App\v1\Couriers\Requests\CreateCourierRequest;
use App\v1\Couriers\Requests\UpdateCourierRequest;
...
class CourierController extends Controller
{
    ...
    {
        return view('servicer.couriers.list', ['couriers' => $this->courierRepo->listCouriers('name', 'asc')]);
    }
    ...
    {
        return view('servicer.couriers.create');
    }
    ...
    public function store(CreateCourierRequest $request)
    {
        ...
        return redirect()->route('servicer.couriers.index');
    }
    ...
    {
        return view('servicer.couriers.edit', ['courier' => $this->courierRepo->findCourierById($id)]);
    }
    ...
    public function update(UpdateCourierRequest $request, $id)
    {
        ...
        return redirect()->route('servicer.couriers.edit', $id);
    }
