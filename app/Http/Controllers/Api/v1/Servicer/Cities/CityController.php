...
class CityController extends Controller
{
    ...
    public function edit($countryId, $provinceId, $city)
    {
        ...
        return view('servicer.cities.edit', [
            'countryId' => $countryId,
    ...
    public function update(UpdateCityRequest $request, $countryId, $provinceId, $city)
    {
        ...
        return redirect()
            ->route('servicer.countries.provinces.cities.edit', [$countryId, $provinceId, $city])
