...
namespace App\Shop\Servicers\Repositories;

use Jsdecena\Baserepo\BaseRepository;
use App\Shop\Servicers\Servicer;
use App\Shop\Servicers\Exceptions\ServicerNotFoundException;
...
class ServicerRepository extends BaseRepository implements ServicerRepositoryInterface
{
    ...
    {
        $data['password'] = Hash::make($data['servicer_password']);
    ...
    public function findServicerById(int $id): Servicer
    {
        try {
            ...
            throw new ServicerNotFoundException;
        }
    }
